...
//	}
	 ...
	 * returns null (although it may return the NullTreeCheckingModel singleton).
	 ...
	 * @throws IllegalArgumentException if the argument is not a <code>CheckboxTreeCellRenderer</code>.
	 */
	@Override
